<template>
  <div class="h-full flex w-full from-indigo-900 bg-gradient-to-b to-gray-800">
    <div class="container mx-auto flex flex-col">
      <div class="flex-grow flex">
        <git-files-area :title="'Untracked Files'"></git-files-area>
        <git-files-area :title="'Modified Files'"></git-files-area>
        <git-files-area :title="'Staged Files'"></git-files-area>
...
import GitFilesArea from '../components/GitFilesArea.vue'

export default {
  components: { GitActions, GitFilesArea },
  filters: {
